# Golfixation Quick Start Guide

Golfixation replaces paper scorecards with live, collaborative scoring for golf tournaments. Captains enter scores hole-by-hole from their phones, and spectators follow the action on a real-time leaderboard.
...
| Problem | What to do |
| --- | --- |
| Magic link opens in browser instead of the app | Use the email code option instead. |
